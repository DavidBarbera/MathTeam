...
Scene::Scene() : windowWidth(0), windowHeight(0),
drawModeChanged(false), drawMode(0),
cameraAngleX(CAMERA_ANGLE_X), cameraAngleY(CAMERA_ANGLE_Y),
cameraDistance(CAMERA_DISTANCE), windowSizeChanged(false)
{
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setCamera(float posX, float posY, float posZ, float targetX, float targetY, float targetZ)
{
	float forward[4];
	float up[4];
	float left[4];
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setViewportSub(int x, int y, int width, int height, float nearPlane, float farPlane)
{
	// set viewport
...
///////////////////////////////////////////////////////////////////////////////
void Scene::drawAxis(float size)
{
...
// draw frustum
///////////////////////////////////////////////////////////////////////////////
void Scene::drawFrustum(float fovY, float aspectRatio, float nearPlane, float farPlane)
{
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setViewMatrix(float x, float y, float z, float pitch, float heading, float roll)
{
	cameraPosition[0] = x;
	cameraPosition[1] = y;
	cameraPosition[2] = z;
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setModelMatrix(float x, float y, float z, float rx, float ry, float rz)
{
	modelPosition[0] = x;
	modelPosition[1] = y;
	modelPosition[2] = z;
...
void Scene::updateViewMatrix()
{
	...
	matrixView = glm::mat4(1.0f);
	matrixView = glm::translate(glm::vec3(-cameraPosition[0], -cameraPosition[1], -cameraPosition[2]));
	matrixView = glm::rotate(-cameraAngle[0], glm::vec3(1, 0, 0));   // pitch
	matrixView = glm::rotate(-cameraAngle[1], glm::vec3(0, 1, 0));   // heading
	matrixView = glm::rotate(-cameraAngle[2], glm::vec3(0, 0, 1));   // roll
...
void Scene::updateModelMatrix()
{
	...
	matrixModel = glm::mat4(1.0f);
	matrixModel = rotate(modelAngle[2], glm::vec3(0, 0, 1));
	matrixModel = rotate(modelAngle[1], glm::vec3(0, 1, 0));
	matrixModel = rotate(modelAngle[0], glm::vec3(1, 0, 0));
	matrixModel = translate(glm::vec3(modelPosition[0], modelPosition[1], modelPosition[2]));
...
///////////////////////////////////////////////////////////////////////////////
void Scene::rotateCamera(int x, int y)
{
...
///////////////////////////////////////////////////////////////////////////////
void Scene::zoomCamera(int y)
{
	cameraDistance -= (y - mouseY) * 0.1f;
	mouseY = y;
}
void Scene::zoomCameraDelta(int delta)
{
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setFrustum(float l, float r, float b, float t, float n, float f)
{
	matrixProjection = glm::mat4(1.0f);
...
///////////////////////////////////////////////////////////////////////////////
void Scene::setFrustum(float fovY, float aspectRatio, float front, float back)
{
...
// Note: this is for row-major notation. OpenGL needs transpose it
///////////////////////////////////////////////////////////////////////////////
void Scene::setOrthoFrustum(float l, float r, float b, float t, float n, float f)
{
	matrixProjection = glm::mat4(1.0f);
